...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_D1OlwPvN.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "D:/forked-projs/beens/node_modules/.pnpm/astro@4.12.1_@types+node@20.14.11_typescript@5.5.3/node_modules/astro/components/Image.astro", void 0);
...
}, "D:/forked-projs/beens/node_modules/.pnpm/astro@4.12.1_@types+node@20.14.11_typescript@5.5.3/node_modules/astro/components/Picture.astro", void 0);
